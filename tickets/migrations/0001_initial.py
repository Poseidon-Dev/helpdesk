# Generated by Django 3.2 on 2021-04-14 04:32
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assocaited_employee', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='tickets.employees', verbose_name='Employees')),
                ...
                ('submitter', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='submitter', to='tickets.users')),
                ('technician', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='technician', to='tickets.users')),
            ],
            options={
                'verbose_name': 'Ticket',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('date', models.DateTimeField(default=datetime.datetime(2021, 4, 14, 4, 32, 53, 769516, tzinfo=utc), verbose_name='Date')),
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='commenter', to='tickets.users')),
            ],
            options={
